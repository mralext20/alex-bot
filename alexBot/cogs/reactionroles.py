...
class ReactionRoles(Cog):
    ...
    async def add_reaction_role(self, message: discord.Message, reaction: str, role: discord.Role):
        ...
        await self.bot.db.execute("""INSERT INTO reactionRoles (guildId, messageId, reaction, roleId) VALUES (?,?,?,?)""",
                                  (
                                      message.guild.id,
                                      message.id,
                                      reaction,
    ...
    async def setup_reaction_role(self, ctx: commands.Context, channel: discord.TextChannel, role: discord.Role, reaction: str):
        try:

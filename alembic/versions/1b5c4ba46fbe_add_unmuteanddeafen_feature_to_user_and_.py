...
def upgrade() -> None:
    ...
    op.add_column('guildconfigs', sa.Column('allowUnMuteAndDeafenOnJoin', sa.Boolean(), server_default='false', nullable=False))
    op.add_column('userconfigs', sa.Column('unMuteAndDeafenOnJoin', sa.Boolean(), server_default='false', nullable=False))

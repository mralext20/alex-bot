...
def upgrade() -> None:
    ...
    op.create_table('sugeryzonenames',
    ...
    sa.ForeignKeyConstraint(['alertsTranslationsId'], ['sugeryzonenames.id'], ),
    sa.ForeignKeyConstraint(['namesId'], ['sugeryzonenames.id'], ),
